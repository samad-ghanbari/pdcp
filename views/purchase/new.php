...
?>
    ...
    <?php
    $form = ActiveForm::begin(['action'=>Yii::$app->request->baseUrl."/purchase/insert",
        'id'=>"recForm",
    ...
    <?= $form->field($model, 'title', ['labelOptions' => ['style' => 'color:white;'], 'options'=>['style'=>'display:block; width: 100%;']])->textInput(['maxlength' => true, 'style'=>"direction:rtl"]) ?>
